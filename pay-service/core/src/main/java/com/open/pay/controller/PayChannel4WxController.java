...
import com.open.pay.service.channel.wechat.WxPayProperties;
import com.open.pay.service.channel.wechat.WxPayUtil;
import com.open.common.constant.PayConstant;
import com.open.common.constant.PayEnum;
...
public class PayChannel4WxController{
    ...
    public String doWxPayReq(@RequestParam String jsonParam) {
        try{
            JSONObject paramObj = JSON.parseObject(new String(Base64Utils.decode(jsonParam)));
            ...
            if("".equals(resKey)) return XXPayUtils.makeRetFail(XXPayUtils.makeRetMap(PayConstant.RETURN_VALUE_FAIL, "", PayConstant.RETURN_VALUE_FAIL, PayEnum.ERR_0001));
            ...
            try {
                ...
                Map<String, Object> map = XXPayUtils.makeRetMap(PayConstant.RETURN_VALUE_SUCCESS, "", PayConstant.RETURN_VALUE_SUCCESS, null);
                ...
                return XXPayUtils.makeRetData(map, resKey);
                ...
                return XXPayUtils.makeRetData(XXPayUtils.makeRetMap(PayConstant.RETURN_VALUE_SUCCESS, "", PayConstant.RETURN_VALUE_FAIL, "0111", "调用微信支付失败," + e.getErrCode() + ":" + e.getErrCodeDes()), resKey);
            }
        }catch (Exception e) {
            _log.error(e, "微信支付统一下单异常");
            return XXPayUtils.makeRetFail(XXPayUtils.makeRetMap(PayConstant.RETURN_VALUE_FAIL, "", PayConstant.RETURN_VALUE_FAIL, PayEnum.ERR_0001));
        }
    }
